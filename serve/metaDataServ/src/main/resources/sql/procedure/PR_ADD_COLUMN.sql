...
BEGIN
	...
	IF V_COUNT = 1 THEN
		...
		IF V_COUNT = 0 THEN
			...
			SET @V_SQL = CONCAT(" ALTER TABLE ", V_TABLE_SCHEMA, ".", V_TABLE_NAME, " ADD COLUMN ", V_COL_NAME, " ", V_COL_DATA_TYPE, V_COL_FINAL_SCALE, " ",
								V_COL_DEFAULT_SQL, " COMMENT '", V_COL_REMARK, "'");
